package com.fastudent.orderplacing;
...
public class OrderPlace extends TestSuiteBase {
	...
	public void checkTestSkip() {
		...
		if (!TestUtil.isTestCaseRunnable(suite_orderplacing_xls, this.getClass().getSimpleName())) {
		//	APP_LOGS.debug("Skipping Test Case" + this.getClass().getSimpleName() + " as runmode set to NO");// logs
			throw new SkipException("Skipping Test Case" + this.getClass().getSimpleName() + " as runmode set to NO");// reports
		}
		// load the runmodes off the tests
		runmodes = TestUtil.getDataSetRunmodes(suite_orderplacing_xls, this.getClass().getSimpleName());
}
...
driver.findElement(By.xpath(".//*[@id='head-top-nav']/li[2]")).click();
		...
		driver.findElement(By.xpath(".//*[@id='coupon_code']")).sendKeys("FSTZEROCOD");
		//click on order place button
		driver.findElement(By.xpath(".//*[@id='aw-onestepcheckout-place-order-button']")).click();
		//click on vocational category
		//driver.findElement(By.xpath("html/body/div[3]/div/div[1]/div[1]/div[2]/div/div/div/div/ul/li[6]/a")).click();
		 // driver.findElements(By.xpath(".//*[@id='amshopby-page-container']/div[1]/h1"));
		  //click on whishlist
		//driver.findElement(By.xpath(".//*[@id='amshopby-page-container']/div[3]/ul/li[1]/div/div[2]/div[3]/a[1]/i")).click();
		//click on add to cart button
		//driver.findElement(By.xpath(".//*[@id='wishlist-view-form']/fieldset/div/button[2]")).click();
	...
	public void reportDataSetResult() {
		if (skip)
			TestUtil.reportDataSetResult(suite_orderplacing_xls, this.getClass().getSimpleName(), count + 2, "SKIP");
		else if (fail) {
			isTestPass = false;
			TestUtil.reportDataSetResult(suite_orderplacing_xls, this.getClass().getSimpleName(), count + 2, "FAIL");
		} else
			TestUtil.reportDataSetResult(suite_orderplacing_xls, this.getClass().getSimpleName(), count + 2, "PASS");
	...
	public void reportTestResult() {
		if (isTestPass)
			TestUtil.reportDataSetResult(suite_orderplacing_xls, "Test Cases",
					TestUtil.getRowNum(suite_orderplacing_xls, this.getClass().getSimpleName()), "PASS");
		else
			TestUtil.reportDataSetResult(suite_orderplacing_xls, "Test Cases",
					TestUtil.getRowNum(suite_orderplacing_xls, this.getClass().getSimpleName()), "FAIL");
